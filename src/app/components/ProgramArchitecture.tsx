...
export function ProgramArchitecture() {
  const features = [
    ...
    },
    {
      icon: TrendingUp,
      title: "Подвійна сила",
      description: "До нашого процесу приєднується другий тренер. Це дає вам можливість бачити різні стилі роботи та отримувати вдвічі більше професійної експертизи."
    },
    {
      icon: Network,
      title: "Нетворкінг",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <div className="max-w-4xl mx-auto space-y-4 text-lg text-gray-700">
            <p>
              Ми підготували для вас унікальну архітектуру курсу. Ви починаєте в камерних групах (офлайн або онлайн), щоб створити безпечний простір для перших кроків.
            </p>
