...
export function ChooseYourGoal() {
  ...
  const personalFeatures = [
    ...
    "Зцілення дитячих травм: розплутати власні дитячі травми та страхи, які «передаються» далі по роду, регулювати свою тривогу, знайти спокій",
    "Простір власної терапії: безпечний простір пройти власну терапію, перевірити покликання, отримати досвід клієнтської ролі на 1 ступені і без тиску вирішити - йти далі чи ні",
    "Звільнення від провини та сорому: розібрати хронічну провину та сором, повернути право на бажання, гнів, межі. Відчути: «Я можу бути собою - і це нормально»"
