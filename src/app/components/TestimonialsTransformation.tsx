...
export function TestimonialsTransformation() {
  const testimonials: Testimonial[] = [
    {
      before: "Була постійно з почуттям вини, не могла сказати «ні», не знала, чого хочу насправді, всім намагалася догодити, супертривожна, вічних муках вибору і страху, з вічною невпевненістю в собі.",
      after: "А здобула саму цінність себе і життя. Світ став більшим і яскравішим.",
      author: "Студентка 1 ступеня 2025",
      description: "",
      image: "https://images.unsplash.com/photo-1765648763932-43a3e2f8f35c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400"
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1602800511335-405b1ea25621?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400"
    },
    {
